...
const navItems: NavItem[] = [
    { name: 'Home', href: '#' },
    { name: 'Services', href: '#', subItems: [{ name: 'HTML', href: '#' }] },
    { name: 'About Us', href: '#' },
    ...
    return (
        <header className="bg-[#f2f7fd]">
            <div className="container mx-auto">
                <nav className="flex max-w-7xl items-center justify-between pt-4 pb-2 lg:px-8" aria-label="Global">
                ...
                {isMobileMenuOpen && (
                    <div className="lg:hidden" role="dialog" aria-modal="true">
                        ...
                        <div className="fixed inset-y-0 right-0 z-10 w-full overflow-y-auto bg-[#f2f7fd] px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
